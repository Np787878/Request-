...
export default function App() {
  ...
  return (
    <div className="min-h-screen selection:bg-pink-100 selection:text-pink-600 font-sans pb-20 bg-[#fffafd]">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 bg-[#fffafd]">
          <iframe
            ...
            src="https://go.screenpal.com/watch/cOhYYwntpde"
      ...
      {/* Main Content Card */}
      <section className="max-w-4xl mx-auto px-4 md:px-6 -mt-12 relative z-20">
        <motion.div
           initial={{ opacity: 0, y: 40 }}
           whileInView={{ opacity: 1, y: 0 }}
           viewport={{ once: true, margin: "-50px" }}
           transition={{ duration: 0.8, ease: "easeOut" }}
           className="bg-white/95 backdrop-blur-2xl rounded-[2.5rem] md:rounded-[4rem] p-8 md:p-24 text-card border border-white shadow-[0_40px_100px_-20px_rgba(255,182,193,0.1)]"
        >
          <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-12 md:y-16 text-gray-600 font-serif text-lg md:text-[1.2rem] leading-[1.8] md:leading-[2] max-w-2xl mx-auto text-left md:text-center">
              <p>
              ...
              <div className="relative py-8 md:py-10 px-8 md:px-12 italic text-left border-l-4 border-pink-100 bg-pink-50/20 rounded-r-3xl transition-colors hover:bg-pink-50/30">
                <span className="absolute top-2 left-2 text-5xl md:text-6xl text-pink-100 font-serif opacity-30">"</span>
                <p className="relative z-10 pl-2 md:pl-4">
              ...
              <motion.div 
                ...
                className="mt-16 md:mt-24 p-8 md:p-12 rounded-[2.5rem] md:rounded-[3.5rem] bg-gradient-to-br from-pink-50/40 to-white border border-pink-100/40 shadow-[0_20px_40px_rgba(255,192,203,0.05)]"
              >
                <p className="italic text-pink-500 text-lg md:text-[1.25rem] font-serif leading-[1.6] md:leading-[1.8] text-center">
      ...
      <section className="mt-32 text-center px-6">
        <h3 className="font-serif italic text-pink-300 text-[0.8rem] tracking-[0.6em] uppercase mb-16">
          Send a Response · Connect here Directly
        </h3>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 px-6">
          <motion.a
            ...
            className="flex items-center gap-4 instagram-gradient text-white px-10 py-5 rounded-[2rem] shadow-[0_20px_40px_-10px_rgba(220,39,67,0.2)] w-full md:w-auto md:min-w-[280px] justify-center transition-all hover:shadow-[0_30px_60px_-10px_rgba(220,39,67,0.3)]"
          >
            <Instagram size={24} />
            <span className="font-bold tracking-[0.2em] uppercase text-[0.65rem]">Instagram</span>
          </motion.a>
          ...
          <motion.a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 whatsapp-gradient text-white px-10 py-5 rounded-[2rem] shadow-[0_20px_40px_-10px_rgba(18,140,126,0.2)] w-full md:w-auto md:min-w-[280px] justify-center transition-all hover:shadow-[0_30px_60px_-10px_rgba(18,140,126,0.3)]"
          >
            <MessageCircle size={24} />
            <span className="font-bold tracking-[0.2em] uppercase text-[0.65rem]">WhatsApp</span>
          </motion.a>
        </div>
      </section>
